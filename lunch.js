...
const whatToDoForLunch = function(hungry, availableTime) {
  //This means if hungry = false
  if (!hungry) {
    //The return statement is present because if hungry = false if won't run what's below
    return console.log('I guess wait until you\'re hungry :)');
  }
  ...
  if (availableTime < 30) {
    ...
    //If none of those if statements apply, it will return the statment below 
